...
save_path = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/fusion_3_model/minimum"
...
for comb in combinations(local, 3):
    ...
    result_fusion = [np.minimum(prob_lesion_model_1,prob_lesion_model_2,prob_lesion_model_3),np.minimum(prob_normal_model_1,prob_normal_model_2,prob_normal_model_3)]
    ...
    # Threshold ótimo na curva PR = minimiza F1-score
    ...
    def threshold_otimo_pr(precision, recall, thresholds):
        """
        Encontra o threshold que minimiza o F1-score na curva PR.
