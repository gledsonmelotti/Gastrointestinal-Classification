...
# =========================================================
# CONFIGURAÇÃO DAS COMBINAÇÕES DE LATE FUSION (PROD-NORM POST-HOC)
# Os arquivos .mat foram gerados pelo prod_norm_late_fusion_post_hoc.py
# e salvos em late_fusion_post_hoc/fusion_3_model/prod_norm, com os seguintes padrões
# de nome:
...
# =========================================================
save_path_late_fusion = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/fusion_3_model/prod_norm"
...
modelos = [{
        'nome': f'Late Fusion (Prod-Norm) — {nomes_modelos[m1]} + {nomes_modelos[m2]} + {nomes_modelos[m3]}',
...
save_path = '/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/fusion_3_model/prod_norm/comparacao_prod_norm_late_fusion/'
...
# =========================================================
print('Avaliando combinações de late fusion (prod-norm post-hoc)...')
...
# Título
titulo = doc.add_heading('Comparação de Combinações — Late Fusion (Prod-Norm Post-Hoc) — Dataset Gastrointestinal', level=1)
