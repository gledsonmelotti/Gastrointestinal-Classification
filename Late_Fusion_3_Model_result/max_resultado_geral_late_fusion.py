...
# e salvos em late_fusion_post_hoc/fusion_3_model/maximum, com os seguintes padrões
# de nome:
...
# =========================================================
save_path_late_fusion = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/fusion_3_model/maximum"
...
modelos = [{
        'nome': f'Late Fusion (Maximum) — {nomes_modelos[m1]} + {nomes_modelos[m2]} + {nomes_modelos[m3]}',
...
save_path = '/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/fusion_3_model/maximum/comparacao_maximum_late_fusion/'
