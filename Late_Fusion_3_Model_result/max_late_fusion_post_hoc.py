...
save_path = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/fusion_3_model/maximum"
...
for comb in combinations(local, 3):
    ...
    result_fusion = [np.maximum(prob_lesion_model_1,prob_lesion_model_2,prob_lesion_model_3),np.maximum(prob_normal_model_1,prob_normal_model_2,prob_normal_model_3)]
