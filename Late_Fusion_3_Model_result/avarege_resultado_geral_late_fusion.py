...
# e salvos em late_fusion_post_hoc/fusion_3_model/average, com os seguintes padrões
# de nome:
...
# =========================================================
save_path_late_fusion = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/fusion_3_model/average"
...
modelos = [{
        'nome': f'Late Fusion (Average) — {nomes_modelos[m1]} + {nomes_modelos[m2]} + {nomes_modelos[m3]}',
...
save_path = '/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/fusion_3_model/average/comparacao_average_late_fusion/'
