...
save_path = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/minimum"
...
for comb in combinations(local, 2):
    ...
    result_fusion = [np.minimum(prob_lesion_model_1,prob_lesion_model_2),np.minimum(prob_normal_model_1,prob_normal_model_2)]
