...
# =========================================================
# CONFIGURAÇÃO DAS COMBINAÇÕES DE LATE FUSION (AVERAGE POST-HOC)
# Os arquivos .mat foram gerados pelo average_late_fusion_post_hoc.py
# e salvos em late_fusion_post_hoc/average, com os seguintes padrões
# de nome:
...
# =========================================================
save_path_late_fusion = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/average"
...
for m1, m2 in combinacoes:
    modelos.append({
        'nome': f'Late Fusion (Average) — {nomes_modelos[m1]} + {nomes_modelos[m2]}',
...
save_path = '/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/average/comparacao_avarage_late_fusion/'
...
# =========================================================
print('Avaliando combinações de late fusion (average post-hoc)...')
...
# Título
titulo = doc.add_heading('Comparação de Combinações — Late Fusion (Average Post-Hoc) — Dataset Gastrointestinal', level=1)
