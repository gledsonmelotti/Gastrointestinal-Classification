...
# =========================================================
# CONFIGURAÇÃO DAS COMBINAÇÕES DE LATE FUSION (NORMALIZED PRODUCT POST-HOC)
# Os arquivos .mat foram gerados pelo mormalized_product_late_fusion_post_hoc.py
# e salvos em late_fusion_post_hoc/prod_norm, com os seguintes padrões
# de nome:
...
# =========================================================
save_path_late_fusion = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/prod_norm"
...
combinacoes = [
    ('convnextv2', 'dinov2'),
    ('convnextv2', 'efficientnetv2m'),
    ('dinov2', 'efficientnetv2m'),
]

modelos = []
for m1, m2 in combinacoes:
    modelos.append({
        'nome': f'Late Fusion (Normalized Product) — {nomes_modelos[m1]} + {nomes_modelos[m2]}',
        'path_predictions': save_path_late_fusion + '/predictions_test' + " _ " + m1 + "_" + m2 + '.mat',
        'path_predict':     save_path_late_fusion + '/test_predict' + "_" + m1 + "_" + m2 + '.mat',
        'path_labels':      save_path_late_fusion + '/test_labels.mat',
    })

save_path = '/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/prod_norm/comparacao_prod_norm_late_fusion/'
...
# =========================================================
print('Avaliando combinações de late fusion (normalized product post-hoc)...')
...
# Título
titulo = doc.add_heading('Comparação de Combinações — Late Fusion (Norm Post-Hoc) — Dataset Gastrointestinal', level=1)
