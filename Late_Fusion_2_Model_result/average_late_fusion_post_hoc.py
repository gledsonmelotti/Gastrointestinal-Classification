...
save_path = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/average"
...
for comb in combinations(local, 2):
    ...
    result_fusion = [(prob_lesion_model_1+prob_lesion_model_2)/2.,(prob_normal_model_1+prob_normal_model_2)/2.]
