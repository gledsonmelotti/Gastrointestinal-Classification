...
# e salvos em late_fusion_post_hoc/minimum, com os seguintes padrões
# de nome:
...
# =========================================================
save_path_late_fusion = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/minimum"
...
for m1, m2 in combinacoes:
    modelos.append({
        'nome': f'Late Fusion (Minimum) — {nomes_modelos[m1]} + {nomes_modelos[m2]}',
...
save_path = '/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/minimum/comparacao_minimum_late_fusion/'
