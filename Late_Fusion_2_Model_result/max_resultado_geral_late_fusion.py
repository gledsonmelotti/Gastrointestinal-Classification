...
# =========================================================
# CONFIGURAÇÃO DAS COMBINAÇÕES DE LATE FUSION (MAXIMUM POST-HOC)
# Os arquivos .mat foram gerados pelo maximum_late_fusion_post_hoc.py
# e salvos em late_fusion_post_hoc/maximum, com os seguintes padrões
# de nome:
...
# =========================================================
save_path_late_fusion = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/maximum"
...
for m1, m2 in combinacoes:
    modelos.append({
        'nome': f'Late Fusion (Maximum) — {nomes_modelos[m1]} + {nomes_modelos[m2]}',
...
save_path = '/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/maximum/comparacao_maximum_late_fusion/'
...
# =========================================================
print('Avaliando combinações de late fusion (maximum post-hoc)...')
...
# Título
titulo = doc.add_heading('Comparação de Combinações — Late Fusion (maximum Post-Hoc) — Dataset Gastrointestinal', level=1)
