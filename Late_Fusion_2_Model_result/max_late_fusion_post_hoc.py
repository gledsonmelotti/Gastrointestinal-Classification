...
save_path = "/media/gledson/Dados1/Classificação_GastroIntestinal/classificar_original/late_fusion_post_hoc/maximum"
...
for comb in combinations(local, 2):
    print(comb)
    ...
    result_fusion = [np.maximum(prob_lesion_model_1,prob_lesion_model_2),np.maximum(prob_normal_model_1,prob_normal_model_2)]
    fusion = np.column_stack(result_fusion)
    sio.savemat(save_path + '/predictions_test' + " _ " + comb[0] + "_" + comb[1] + '.mat',
    ...
    sio.savemat(save_path + '/test_predict' + "_" + comb[0] + "_" + comb[1] + '.mat',
    ...
    plt.title('Curva ROC por Classe' + " - " + comb[0] + "_" + comb[1], fontsize=12)
    plt.legend(loc='lower right', fontsize=9)
    plt.grid(True, alpha=0.3)
    plt.xlim([0.0, 1.0])
    plt.ylim([0.0, 1.05])
    plt.tight_layout()
    plt.savefig(os.path.join(save_path, comb[0] + '_' + comb[1] + '_' + 'ROC_por_classe.png'), dpi=600, bbox_inches='tight')
    plt.show()
    ...
    plt.title('Curva PR por Classe' + " - " + comb[0] + "_" + comb[1], fontsize=12)
    plt.legend(loc='lower left', fontsize=9)
    plt.grid(True, alpha=0.3)
    plt.xlim([0.0, 1.0])
    plt.ylim([0.0, 1.05])
    plt.tight_layout()
    plt.savefig(os.path.join(save_path, comb[0] + '_' + comb[1] + '_' + 'PR_por_classe.png'), dpi=600, bbox_inches='tight')
    plt.show()
    
    # =========================================================
    # SALVAR MÉTRICAS EM ARQUIVO TEXTO
    # =========================================================
    with open(os.path.join(save_path, comb[0] + '_' + comb[1] + '_' + 'metricas_por_classe.txt'), 'w') as f:
        f.write('=' * 60 + '\n')
